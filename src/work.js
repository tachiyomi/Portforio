...
const Plane = ({position})=>{
  ...
  return (<mesh ref={ref} receiveShadow>
    <boxGeometry attach='geometry' args={[1000,1000]}/>
  ...
  return (<div css={theme}>
    <Canvas camera={{
      ...
      <Provider>
        ...
        <Box position={[2, 1, 5]} args={[1, 1, 1]}/>
        <Box position={[0, 0, 6]} args={[2, 2, 2]}/>
        <Box position={[-1, 1, 8]} args={[1, 1, 1]}/>
        <Box position={[-2, 2, 13]} args={[2, 2, 2]}/>
        <Box position={[2, -1, 13]} args={[1, 1, 1]}/>
      </Provider>
    </Canvas>
  </div>);
};
